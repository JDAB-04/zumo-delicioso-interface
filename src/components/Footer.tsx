      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Ofrecemos las frutas más frescas directamente del campo a tu mesa. Calidad garantizada y servicio excepcional.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="h-10 w-10 flex items-center justify-center rounded-full bg-gray-800 hover:bg-fruit-green transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="#" className="h-10 w-10 flex items-center justify-center rounded-full bg-gray-800 hover:bg-fruit-orange transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="text-fruit-green mr-2">📍</span>
                <span className="text-gray-400">Calle 170 #35-23 Bogotá - Colombia</span>
              </li>
              <li className="flex items-start">
                <span className="text-fruit-green mr-2">📞</span>
                <span className="text-gray-400">+57 313 441 98 25</span>
              </li>
              <li className="flex items-start">
                <span className="text-fruit-green mr-2">✉️</span>
                <span className="text-gray-400">clientes@frutafresca.com.co</span>
              </li>
              <li className="flex items-start">
                <span className="text-fruit-green mr-2">⏰</span>
                <span className="text-gray-400">Lun - Sáb: 8:00am - 10:00pm</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-500">
            © {new Date().getFullYear()} Fruta Fresca. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
